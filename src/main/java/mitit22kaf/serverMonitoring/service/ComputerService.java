...
import mitit22kaf.serverMonitoring.pojo.ComputerClassroomResponse;
    ...
    public List<ClassroomsResponse> getClassroomsResponses() {
        ...
        for (Map.Entry<Short, List<ComputerData>> computerDataList :
            ...
            classroomsResponse.setSpeed((float) computerDataList.getValue()
                    .stream()
                    .mapToDouble(i -> {
                        classroomsResponse.getComputers().add(new ComputerClassroomResponse(i.getNumberPс(), i.isLoaded()));
